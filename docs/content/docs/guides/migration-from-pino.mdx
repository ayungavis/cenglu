...
| Built-in Redaction | ❌ | ✅ |
| AsyncLocalStorage | ❌ | ✅ |
| Middleware | Limited | Express, NestJS, Fastify, Koa |
| Type Safety | ⚠️ | ✅ Full |
...
// Pino: ~0.38 seconds (263,158 ops/sec)
// Cenglu: ~0.45 seconds (222,222 ops/sec)
```

Cenglu is ~15% slower than Pino in pure logging speed, but includes:
- Built-in redaction
...
- [Configuration](/docs/getting-started/configuration) - Configure cenglu
- [Express Middleware](/docs/middleware/express) - Express integration
- [Built-in Plugins](/docs/plugins/built-in-plugins) - Extend functionality
