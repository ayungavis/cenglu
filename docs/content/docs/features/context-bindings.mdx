...
- [Middleware](/docs/middleware/express) - Framework integration
- [Distributed Tracing](/docs/features/distributed-tracing) - Trace context propagation
- [Architecture](/docs/architecture/data-flow) - How context flows through the logger
