...
- [File Transport](/docs/transports/file) - Persistent logs with rotation
- [Custom Transports](/docs/transports/custom) - Implement your own transport
- [Pretty Formatting](/docs/features/formatting) - Readable development logs
- [Configuration](/docs/getting-started/configuration) - Transport configuration options
