...
- [Logger API](/docs/api/logger) - Logger class methods and usage
- [Plugins API](/docs/plugins/creating-plugins) - Plugin development guide
- [Custom Transports](/docs/transports/custom) - Transport development guide
