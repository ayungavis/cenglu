...
- [Configuration](/docs/getting-started/configuration) - Optimize configuration
- [Plugins](/docs/plugins/built-in-plugins) - Choose efficient plugins
- [Troubleshooting](/docs/troubleshooting/common-issues) - Performance issues
