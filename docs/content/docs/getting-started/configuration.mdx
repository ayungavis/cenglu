...
- [Architecture](/docs/architecture/system-design) - Understand how cenglu works
- [Plugins](/docs/plugins/creating-plugins) - Extend logger functionality
- [Middleware](/docs/middleware/express) - Integrate with frameworks
